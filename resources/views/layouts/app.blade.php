...
<head>
    ...
    <title>@yield('title', 'Sistem MBG') - Monitoring Distribusi Makanan Bergizi</title>
...
<header class="topbar">
    ...
    <div class="topbar-right">
        <div class="text-end d-none d-md-block">
            <div style="font-size:.85rem;font-weight:700;color:#1e293b;">{{ auth()->user()->name }}</div>
            <div style="font-size:.75rem;color:#64748b;">{{ auth()->user()->role_label }}</div>
        </div>
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" style="border-radius:12px;border:none;box-shadow:0 8px 32px rgba(0,0,0,.12);">
                <li><span class="dropdown-item-text fw-bold py-2">{{ auth()->user()->name }}</span></li>
