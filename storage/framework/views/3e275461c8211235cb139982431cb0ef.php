...
<body>
    <div class="error-box">
        ...
        <p class="mb-4"><?php echo e($exception->getMessage() ?: 'Anda tidak memiliki izin untuk mengakses halaman ini.'); ?></p>
        <a href="<?php echo e(url()->previous()); ?>" class="btn btn-primary me-2">
            <i class="bi bi-arrow-left me-2"></i>Kembali
        </a>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary">Login Ulang</a>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\mbg-system\resources\views\errors\403.blade.php ENDPATH**/ ?>