    ...
    <div class="col-lg-7">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('guru.orders.update', $order->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal_pengiriman"
                               ...
                               min="{{ $min_date }}"
                               value="{{ old('tanggal_pengiriman', \Carbon\Carbon::parse($order->tanggal_pengiriman)->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="jumlah_porsi_besar" id="qty-besar"
                                           ...
                                           value="{{ old('jumlah_porsi_besar', $order->jumlah_porsi_besar) }}" min="0" max="200" readonly>
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="jumlah_porsi_kecil" id="qty-kecil"
                                           ...
                                           value="{{ old('jumlah_porsi_kecil', $order->jumlah_porsi_kecil) }}" min="0" max="200" readonly>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="catatan" class="form-control" rows="3"
                                  ...
                                  maxlength="500">{{ old('catatan', $order->catatan) }}</textarea>
